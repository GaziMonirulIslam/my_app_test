...
import com.example.anabi.finalyearproject1try.RamTechnology.RamDDR;
import com.example.anabi.finalyearproject1try.RamTechnology.RamDimm;
...
public class DesktopRamTechTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ramDIMM = (CardView)v.findViewById(R.id.ramDimmId);
        ...
        ramDDR.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getContext(),RamDDR.class);
                startActivity(intent);
            }
        });
        ...
        ramDIMM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {


                Intent intent = new Intent(getContext(),RamDimm.class);
                startActivity(intent);
            }
        });
